...
import dataTable from '@/services/fake/authenticated/HumanResources/Employees/Catalogs/NumberTypes/dataTable'

export default function DataTableNumberTypes({ numberRows, searchStatus, search }) {
  ...
  const handleShow = (rowData, tableData, e) => {
    router.push('/system/human-resources/employees/catalogs/number-types/:id')
  }

  const handleEdit = (rowData, e) => {
    router.push('/system/human-resources/employees/catalogs/number-types/:id/edit')
  }
  ...
  const columnsDataTable = [
    ...
    { id: 2, field: 'status', header: 'Estatus', body: statusBodyTemplate, w: '180px', t: 'center' },
    { id: 3, field: 'actions', header: 'Acciones', body: actionsBodyTemplate, w: '210px', t: 'center' }
  ]
