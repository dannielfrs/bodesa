...
export default function FormGenders({ title, createMode, showMode, editMode }) {
  ...
  const onSubmit = () => {
    ...
    setTimeout(() => {
      Swal.close()
      router.push('/system/human-resources/employees/catalogs/genders')
    }, 4000)
  }
          ...
          <div className={styles.section_header_group}>
            <div>
              <Button
                label='Regresar'
                type='button'
                onClick={() => router.push('/system/human-resources/employees/catalogs/genders')}
                variant='secondary'
                height='45px'
              />
            </div>
