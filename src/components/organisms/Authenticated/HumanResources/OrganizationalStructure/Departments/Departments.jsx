...
import dataTable from '@/services/fake/authenticated/HumanResources/Departments/dataTable'
        ...
        <div className={styles.section_table_actions}>
          <div className={styles['cont-btn']}>
            <Button
              ...
              variant='button_show'
              onClick={() => router.push('/system/human-resources/organizational-structure/departments/id')}
            >
            ...
            <Button
              ...
              tooltipOptions={{ position: 'top' }}
              variant='button_edit'
              onClick={() => router.push('/system/human-resources/organizational-structure/departments/id/edit')}
            >
        ...
        <div className={styles.UsersProfile}>
          <Card className={styles.card_header}>
            <div className={styles.header}>
              <p className={styles.title}>Departamentos</p>
              <div className={styles.partRight}>
                ...
                <div className={styles.ButtonNew}>
                  <Button
                    ...
                    type='button'
                    label='Nuevo'
                    onClick={() => router.push('/system/human-resources/organizational-structure/departments/create')}
                  />
                </div>
              </div>
            </div>
