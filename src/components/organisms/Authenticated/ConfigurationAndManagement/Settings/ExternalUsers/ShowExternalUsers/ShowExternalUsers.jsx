...
export default function ShowExternalUsers ({ disabled, disabledBack, urlCreate }) {
      ...
      <FormHookProvider methods={methods} method='POST' onSubmit={onSubmit}>
        <div className={styles.EditExternalUsers}>
          <HeaderViews
            ...
            onClick={() => router.push('/system/installations/installation')}
            tabs={tabs}
          ...
          <TabView activeIndex={activeIndex} onTabChange={(e) => setActiveIndex(e.index)}>
            <TabPanel header='' className={styles.tabPanel}>
              <div className='m-0'>
                <CreateExternalUsers methods={methods} disabled={disabled} CheckPermissions password />
              </div>
            </TabPanel>
            <TabPanel header='' className={styles.tabPanel}>
              <div className='m-0'>
