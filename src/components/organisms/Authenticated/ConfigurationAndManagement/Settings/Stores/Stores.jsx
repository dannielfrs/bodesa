...
export default function Stores () {
        ...
        <div className={styles.section_table_actions}>
          <div className={styles['cont-btn']}>
            <Button
              ...
              variant='button_show'
              onClick={() => router.push('/system/configuration-and-management/settings/stores/id')}
            >
            ...
            <Button
              ...
              tooltipOptions={{ position: 'top' }}
              variant='button_edit'
              onClick={() => router.push('/system/configuration-and-management/settings/stores/id/edit')}
            >
  ...
  useEffect(() => {
    ...
    methods.setValue('status', 'Estatus')
        ...
        <div className={styles.Stores}>
          <Card className={styles.card_header}>
            <div className={styles.header}>
              <p className={styles.title}>Tiendas</p>
              <div className={styles.partRight}>
                ...
                <div className={styles.ButtonNew}>
                  <Button
                    ...
                    type='button'
                    label='Nuevo'
                    onClick={() => router.push('/system/configuration-and-management/settings/stores/create')}
                  />
                </div>
              </div>
            </div>
